...
let featuresText = [
  `Over twenty-five years of experience shaping refined interiors with precision and care. Our knowledge ensures reliable execution and lasting design quality.`,
  `We design interiors that blend style, comfort, and function. Each space is thoughtfully planned to reflect balance, elegance, and everyday living.`,
  `Our architects apply creative thinking and modern techniques to deliver unique interior solutions that feel both practical and inspiring.`,
  `We focus on clear communication and close collaboration, ensuring every project meets expectations and delivers a satisfying design experience.`,
  `Smart planning and efficient design allow us to create beautiful interiors without unnecessary costs, keeping quality high and budgets respected.`,
  `We select durable, eco-conscious materials that enhance interiors while supporting sustainability, comfort, and long-term environmental responsibility.`,
];
...
let servicesPhotoesText = [
  `We create personalized interior designs that balance style and practicality. Every space is shaped to reflect character, comfort, and modern living needs.`,
  `Our team manages implementation with precision and care, ensuring designs are executed exactly as planned, with quality materials and professional coordination.`,
  `We transform existing spaces through smart renovation solutions that improve functionality, refresh aesthetics, and preserve the character of the interior.`,
  `We design efficient and visually appealing commercial spaces that support productivity, branding, and a welcoming atmosphere for clients and employees.`,
];
